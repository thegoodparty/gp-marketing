...
export const editorialOverview = {
	...
	preview: {
		...
		prepare: x => {
			...
			const title = resolveValue('title', editorialOverview.preview.select, x);
			const subtitle = resolveValue('subtitle', editorialOverview.preview.select, x);
			const media = resolveValue('media', editorialOverview.preview.select, x);
