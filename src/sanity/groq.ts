...
/*language=textmate*/
// FAQ hrefs use stored field_slug only (no _id fallback). Post-merge backfill required:
// bun run sanity:post-merge:faq-internal-links:apply
export const faqHrefGroq = `_type=="faq"=>{"href":select(defined(faqOverview.field_slug)=>"/frequently-asked-questions/"+faqOverview.field_slug)}`;
/*language=textmate*/
