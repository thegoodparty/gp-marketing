...
const styles = tv({
	slots: {
		...
		text: '',
		label: 'inline-block bg-goodparty-blue/[0.08] text-goodparty-blue py-2 px-5 rounded-full text-sm font-semibold uppercase tracking-wider mb-6',
		...
		pillar: 'flex items-start gap-4 p-5 pt-5 pr-6 bg-white rounded-2xl border border-neutral-200 transition-all hover:border-goodparty-blue hover:shadow-[var(--shadow-pillar-hover)]',
		pillarIcon: 'w-11 h-11 rounded-xl bg-gradient-to-br from-goodparty-blue/10 to-goodparty-red/10 flex items-center justify-center text-xl flex-shrink-0',
