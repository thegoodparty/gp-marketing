...
const styles = tv({
	slots: {
		...
		partyIconFaded: 'bg-neutral-100 opacity-50 grayscale after:content-[""] after:absolute after:w-[140%] after:h-[3px] after:bg-goodparty-red after:rotate-[-45deg] after:opacity-60',
		partyIconStar: 'w-[10rem] h-[10rem] bg-gradient-to-br from-red-50 to-white border-[3px] border-goodparty-red shadow-[var(--shadow-party-icon)] z-[2] -mx-5 [animation:float_6s_ease-in-out_infinite]',
	},
});
