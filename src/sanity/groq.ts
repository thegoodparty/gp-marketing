...
/*language=textmate*/
export const quoteGroq = `...,generalContentTags{${tagsGroq}},quote{...,ref_quoteBy->,button{${buttonGroq}}}`;
/*language=textmate*/
