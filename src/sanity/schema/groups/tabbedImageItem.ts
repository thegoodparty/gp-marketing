...
export const tabbedImageItem = {
	...
	preview: {
		...
		prepare: x => {
			...
			const title = resolveValue('title', tabbedImageItem.preview.select, x);
			const subtitle = resolveValue('subtitle', tabbedImageItem.preview.select, x);
			const media = resolveValue('media', tabbedImageItem.preview.select, x);
