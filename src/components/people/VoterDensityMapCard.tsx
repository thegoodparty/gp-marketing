...
/**
 * Card wrapping the voter-density heat map for the district section.
 * Progressive enhancement: this only renders when the server already decided
 * there is enough coverage (see PersonProfile), so there is no in-card
 * empty/error state — just the map, a one-line explainer, and a density legend.
 */
