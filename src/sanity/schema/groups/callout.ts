...
export const callout = {
	...
	preview: {
		...
		prepare: x => {
			...
			const title = resolveValue('title', callout.preview.select, x);
			const subtitle = resolveValue('subtitle', callout.preview.select, x);
			const media = resolveValue('media', callout.preview.select, x);
